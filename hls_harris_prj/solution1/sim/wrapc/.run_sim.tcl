...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "harris.autotvin.dat"
	set constFileTvOut       "harris.autotvout.dat"
	set constFileHdlTvIn     "harris.autohdltvin.dat"
	set constFileHdlTvOut    "harris.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
